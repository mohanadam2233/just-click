...
function createHooks(entityKeys, api, listApiName, detailApiName, createApiName, updateApiName, deleteApiName, bulkDeleteApiName) {
  return {
    ...
    useInfiniteList: (baseParams = {}, options = {}) => useInfiniteQuery({
      queryKey: entityKeys.list({ ...baseParams, mode: "cursor", infinite: true }),
      queryFn: ({ pageParam = "" }) => api[listApiName]({ ...baseParams, mode: "cursor", limit: 10, cursor: pageParam || undefined }),
      initialPageParam: "",
      getNextPageParam: (lastPage) => {
        const pagination = lastPage?.data?.pagination;
        if (pagination?.has_more && pagination?.next_cursor) return pagination.next_cursor;
        return undefined;
      },
      ...options,
    }),
    ...
    useUpdate: (options = {}) => {
      ...
      return useMutation({
        ...
        onSuccess: (data, variables, context) => {
          ...
          queryClient.invalidateQueries({ queryKey: entityKeys.lists() });
          if (id) queryClient.invalidateQueries({ queryKey: entityKeys.detail(id) });
          if (options.onSuccess) options.onSuccess(data, variables, context);
        },
        ...options,
      });
    ...
    useBulkDelete: (options = {}) => {
      ...
      return useMutation({
        ...
        onSuccess: (data, variables, context) => {
          queryClient.invalidateQueries({ queryKey: entityKeys.lists() });
          variables?.ids?.forEach(id => queryClient.removeQueries({ queryKey: entityKeys.detail(id) }));
          if (options.onSuccess) options.onSuccess(data, variables, context);
        },
        ...options,
      });
...
// 1. Faculties
const facultiesGeneric = createHooks(academicKeys.faculties, academicApi, "getFacultiesList", "getFaculty", "createFaculty", "updateFaculty", "deleteFaculty", "bulkDeleteFaculties");
export const { 
...
export const useFacultiesDropdown = (params = {}, options = {}) => useQuery({
...
// 2. Departments
const departmentsGeneric = createHooks(academicKeys.departments, academicApi, "getDepartmentsList", "getDepartment", "createDepartment", "updateDepartment", "deleteDepartment", "bulkDeleteDepartments");
export const { 
...
export const useDepartmentsDropdown = (params = {}, options = {}) => useQuery({
...
// 3. Courses
const coursesGeneric = createHooks(academicKeys.courses, academicApi, "getCoursesList", "getCourse", "createCourse", "updateCourse", "deleteCourse", "bulkDeleteCourses");
export const { 
...
export const useCoursesDropdown = (params = {}, options = {}) => useQuery({
...
// 4. Chapters
const chaptersGeneric = createHooks(academicKeys.chapters, academicApi, "getChaptersList", "getChapter", "createChapter", "updateChapter", "deleteChapter", "bulkDeleteChapters");
export const { 
...
export const useChaptersDropdown = (params = {}, options = {}) => useQuery({
...
// 5. Semesters
const semestersGeneric = createHooks(academicKeys.semesters, academicApi, "getSemestersList", "getSemester", "createSemester", "updateSemester", "deleteSemester", "bulkDeleteSemesters");
export const { 
...
export const useSemestersDropdown = (params = {}, options = {}) => useQuery({
...
// 6. Academic Years
const academicYearsGeneric = createHooks(academicKeys.academicYears, academicApi, "getAcademicYearsList", "getAcademicYear", "createAcademicYear", "updateAcademicYear", "deleteAcademicYear", "bulkDeleteAcademicYears");
export const { 
