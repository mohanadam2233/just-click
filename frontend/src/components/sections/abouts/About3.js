      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-30px pb-30px">
          ...
          <div data-aos="fade-up">
            <SectionNameSecondary>IT DEPARTMENT SOLUTION</SectionNameSecondary>
            <HeadingPrimaryXl>
              Welcome to the IT Digital Materials Hub
            </HeadingPrimaryXl>
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-6 pl-3 border-l-2 border-primaryColor">
              A centralized repository designed specifically for IT departments
              — eliminating fragmented platforms like WhatsApp, Google Drive,
              and email threads.
            </p>
            <ul className="space-y-5">
              <li className="flex items-center group">
                ...
                <p className="text-sm md:text-base font-medium text-blackColor dark:text-blackColor-dark">
                 Access all course materials in one searchable platform
                </p>
              </li>
              <li className="flex items-center group">
                <i className="icofont-check px-2 py-2 text-primaryColor bg-whitegrey3 bg-opacity-40 group-hover:bg-primaryColor group-hover:text-white group-hover:opacity-100 mr-15px dark:bg-whitegrey1-dark"></i>
                <p className="text-sm md:text-base font-medium text-blackColor dark:text-blackColor-dark">
                  Get instant AI-powered explanations based on your actual class documents
                </p>
              </li>
              <li className="flex items-center group">
                <i className="icofont-check px-2 py-2 text-primaryColor bg-whitegrey3 bg-opacity-40 group-hover:bg-primaryColor group-hover:text-white group-hover:opacity-100 mr-15px dark:bg-whitegrey1-dark"></i>
                <p className="text-sm md:text-base font-medium text-blackColor dark:text-blackColor-dark">
                  Track your learning progress and revisit past exam materials
                </p>
              </li>
            </ul>
          </div>
