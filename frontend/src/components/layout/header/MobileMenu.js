...
// components/layout/mobile-menu/MobileMenu.jsx
"use client";
import MobileMenuClose from "@/components/shared/buttons/MobileMenuClose";
...
const MobileMenu = () => {
  return (
    <div className="mobile-menu w-mobile-menu-sm md:w-mobile-menu-lg fixed top-0 -right-[280px] md:-right-[330px] transition-all duration-500 w-mobile-menu h-full shadow-dropdown-secodary bg-white dark:bg-gray-900 z-high block lg:hidden">
      <MobileMenuClose />
